...
### #54 - drive-mcp: `create_label` missing
Labels (6) has list, get, set, remove, search but no create. User tried to create "Processed" label, got "No such tool available". Either add `create_label` tool or document that labels must be created via Drive UI first.
...
- [x] **#55-57 - Token/auth caching issues** - Fixed 2026-01-31. Token management and credential caching issues resolved.
